...
4. Historical deployments and duplicate version trees are excluded from active penetration metrics unless referenced by canonical runtime/CI.
5. Findings return through KEB normalization before child disposition.