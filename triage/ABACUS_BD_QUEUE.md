...
**Evidence-backed closures in this pulse:** #1186, #1187, #1188, #1195, #583, #1256  
**Current open count after those closures:** 24
...
| **VERIFY_CLOSE** | #672, #673, #674, #1002 | Implementation/evidence appears to exist; verify the exact DoV before closing. |
...
3. **#645 / #818 — bounded implementation slices**, not broad refactors.
4. **#1278 stays visible but leaves the runnable crew queue.** Its remaining gate is
